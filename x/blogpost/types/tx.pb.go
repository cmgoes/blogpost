...
func (*MsgCreatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_71ecc15c2857290d, []int{0}
}
...
func (*MsgCreatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_71ecc15c2857290d, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "ytdbuolf.blogpost.blogpost.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "ytdbuolf.blogpost.blogpost.MsgCreatePostResponse")
}

func init() { proto.RegisterFile("blogpost/tx.proto", fileDescriptor_71ecc15c2857290d) }

var fileDescriptor_71ecc15c2857290d = []byte{
	// 221 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ytdbuolf.blogpost.blogpost.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ytdbuolf.blogpost.blogpost.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ytdbuolf.blogpost.blogpost.Msg",
